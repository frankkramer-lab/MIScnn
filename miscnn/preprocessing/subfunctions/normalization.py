...
from miscnn.preprocessing.subfunctions.abstract_subfunction import Abstract_Subfunction
...
Methods:
    ...
    transform:              Pixel intensity value normalization the imaging data
"""
class Normalization(Abstract_Subfunction):
    ...
    #                  Transform                  #
    #---------------------------------------------#
    def transform(self, sample, training=True):
        # Access image
